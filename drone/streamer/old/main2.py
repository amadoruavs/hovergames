...
video_src = Gst.ElementFactory.make("ximagesrc")
...
# Hook up stream
stream_converter = Gst.ElementFactory.make("videoconvert")
stream_scaler = Gst.ElementFactory.make("videoscale")
stream_caps = Gst.caps_from_string("video/x-raw,width=1920,height=1080")
stream_caps_filter = Gst.ElementFactory.make("capsfilter")
stream_caps_filter.set_property("caps", stream_caps)
stream_encoder = Gst.ElementFactory.make("vp8enc")
...
# Hook up record
record_converter = Gst.ElementFactory.make("videoconvert")
record_nvcaps = Gst.caps_from_string("video/x-raw")
record_nvcaps_filter = Gst.ElementFactory.make("capsfilter")
record_encoder = Gst.ElementFactory.make("vp8enc")
